...
//       const res = await fetch("https://adminag-production.up.railway.app/apply", {
//         method: "POST",
//         body: formData,
//       });
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <button
              ...
              className="block text-gray-800 hover:text-green-700 transition font-medium py-2 pl-4"
            >
              AG Foods Canada Jobs
            </button>
            <button className="text-green-700 font-semibold border-b-2 border-green-700 pb-1">
              Apply Now
            </button>
            <a
              href="#"
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div
              ...
              className="block text-green-700 font-semibold py-2 border-l-4 border-green-700 pl-4"
            >
              Apply Now
            </div>
            <a
        ...
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-green-700 text-white py-3 rounded-lg font-bold hover:bg-green-800 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <p className="text-gray-600 mb-8">
            AG Food Visa provides numerous benefits to ensure a comfortable work
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-gray-600">
                  {" "}
                  Housing is provided near the workplace.
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-gray-600">
                  {" "}
                  One-time two-way airfare covered.
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-gray-600">
                  {" "}
                  Full medical and health insurance coverage.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex gap-3">
              ...
              <p className="text-gray-600">
                Opportunity to apply for permanent residency after employment.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-gray-600">
                  {" "}
                  Basic knowledge of English, Urdu, Hindi and Arabic.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-gray-600">
                Health & Fitness: Should be physically fit for the job.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Your request has been submitted successfully.
              <br />
              Our agent will contact you within <strong>24 hours</strong> on
              WhatsApp.
            </p>
          </motion.div>
        </motion.div>
